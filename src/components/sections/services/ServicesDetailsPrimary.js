					...
					<div className="col-lg-8">
						<div className="post-details-wrapper">
							<div className="blog-images wow fadeInUp" data-wow-delay=".1s">
								<Image
									src="https://images.unsplash.com/photo-1601597111158-2fceff292cdc?q=80&fit=crop&w=870&h=450"
									alt="Images"
									width={870}
									height={450}
									style={{ height: "auto" }}
							...
							<div className="blog-text">
								...
								<div className="images-wrap">
									<div className="row">
										<div className="col-sm-6">
											...
											>
												<Image
													src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&fit=crop&w=420&h=420"
													alt="Image"
													width={420}
													height={420}
													style={{ width: "100%", height: "auto", aspectRatio: "1", objectFit: "cover", borderRadius: "10px" }}
												/>
											</div>
										</div>
										<div className="col-sm-6">
											...
											>
												<Image
													src="https://images.unsplash.com/photo-1542382156909-9ae37b3f56fd?q=80&fit=crop&w=420&h=420"
													alt="Image"
													width={420}
													height={420}
													style={{ width: "100%", height: "auto", aspectRatio: "1", objectFit: "cover", borderRadius: "10px" }}
								...
								<p className="wow fadeInUp" data-wow-delay=".3s">
									At Staller Stack, we don't just focus on solving customer problems—we
