						...
						<div className="col-12">
							...
							>
								<div className="subscribe-logo">
									<img src="/images/logos/logo-l.svg" alt="" />
								</div>
						...
						<div className="col-xl-3 col-md-6">
							...
							>
								<div className="footer-logo">
									<Link href="/">
										<img src="/images/logos/logo-l.svg" alt="Logos" />
									</Link>
								</div>
							...
							>
								...
								<div className="footer-contact-info">
									<div className="contact-item">
										<span>5 Penn Plaza, 14th Floor, Newyork, NY , 10001 United States 🇺🇸, USA.</span>
									</div>
									<div className="contact-item">
										<Link href="tel:10095447818">P: +1 (009) 544-7818</Link>
										<Link href="mailto:Hello@stallerstack.us">
